    ...
    >
      ...
      <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop w-full">
        <div className="max-w-2xl">
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-primary mb-6 animate-fade-in-up font-bold leading-tight">
            Crafting Comfort,
            <br />
            Elevating Homes
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              className="inline-flex items-center justify-center px-8 py-4 bg-secondary-container text-on-secondary-container font-label text-sm font-bold rounded shadow-[0_4px_20px_rgba(44,37,35,0.05)] hover:bg-secondary hover:text-on-secondary transition-all duration-300"
              href="#collections"
            >
              Explore Collections
            </a>
            <button
              ...
              className="inline-flex items-center justify-center px-8 py-4 border border-primary/20 text-primary font-label text-sm font-semibold rounded hover:bg-primary/5 transition-all duration-300 cursor-pointer"
            >
              Book a Consultation
            </button>
          </div>
