    ...
    <section id="collections" className="py-24 bg-surface">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="text-center mb-16">
          <h2 className="font-display text-3xl font-semibold text-primary mb-4">Curated Spaces</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter auto-rows-[300px] md:auto-rows-[400px]">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-8">
              <span className="inline-block px-3 py-1 bg-surface-container-lowest text-primary font-label text-xs font-semibold mb-3 rounded-sm">
                Featured
              </span>
              <h3 className="font-display text-2xl font-bold text-on-primary mb-2">Living Room</h3>
              <p className="font-body text-sm text-on-primary/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0 max-w-md">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-8">
              <h3 className="font-display text-2xl font-bold text-on-primary mb-2">Bedroom</h3>
              <p className="font-body text-sm text-on-primary/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
              <h3 className="font-display text-3xl font-bold text-on-primary mb-4">Dining Collection</h3>
              <span className="inline-flex items-center text-on-primary font-label text-sm font-semibold group-hover:underline underline-offset-4 decoration-secondary-container">
